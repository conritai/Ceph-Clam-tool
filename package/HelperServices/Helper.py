...
def outputObjectFromUnscannedToMachine(fileLocation,objectName ):
    ...
    subprocess.Popen(['rados get', f'{objectName}',f'{fileLocation}{objectName}','--pool=for-scan'])
    ...
    if result is None:
        ...
        subprocess.Popen(['rados put', f'{fileLocation}{objectName}(CLEAN)', f'{fileLocation}{objectName}(CLEAN)','--pool=cephfs-data'])
        return 1
        ...
        subprocess.Popen(['rados put', f'{fileLocation}{objectName}(NOT-CLEAN)',f'{fileLocation}{objectName}(NOT-CLEAN)','--pool=cephfs-data'])
        return result